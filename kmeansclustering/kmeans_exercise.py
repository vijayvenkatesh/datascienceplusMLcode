...
def _compute_labels_and_score(X, centers):
    ...
    for sample_idx in xrange(n_samples):
        min_center_dist = np.infty
        for cluster_idx in xrange(n_clusters):
            sample = X[sample_idx]
            center = centers[cluster_idx]
            #computer distance between sample and center
    ...
    #TODO: IMPLEMENT
        ...
        # So once we've found the closest center, add the distance squared to score
